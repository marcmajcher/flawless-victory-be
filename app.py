...
app.config['SECRET_KEY']=';l jskdfpa oihjap9sdh asdlk ga;sdklg asdgja0gaw'
app.config['SQLALCHEMY_DATABASE_URI']='postgresql://localhost/flawless_victory_be_development'
